...
public class Dts_Adding_New_model {
	...
	public void EnterProductDetails()
	{
		...
		{
			System.out.println("Required elements are not present on page or There is no internet access");
		}
	}
	public void SaveProduct()
	{
		...
		//try
		//{
			//wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(Obj.Properties("Save"))));
			try
			{
	...
	public boolean GetSuccessMsg()
	{
		...
		try
		{
			...
			if(msg.contentEquals("Success! Product is saved"))
			{
			return true;
			}
		}
